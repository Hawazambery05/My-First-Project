...
<body>
	...
	<div class="center">
		...
		if (mysqli_num_rows($data1) > 0) {
			...
			echo "No books deleted recently. <br>";
		}
		if (mysqli_num_rows($data5) > 0) {
			...
			echo "No books updated recently. <br>";
		}
		if (mysqli_num_rows($data6) > 0) {
			...
			echo "No books registered recently. <br>";
		}
		?>
		<div>
			<h2>Author</h2>
		...
		if (mysqli_num_rows($data2) > 0) {
			...
			echo "No authors deleted recently. <br>";
		}
		...
		if (mysqli_num_rows($data8) > 0) {
			...
			echo "No authors registered recently. <br>";
		}
		?>
		<div>
			<h2>Category</h2>
