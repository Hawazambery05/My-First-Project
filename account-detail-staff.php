...
<div class="flex-container">
	...
	<div class="form-container-staff2">
		<form method='POST'>
			<p>Staff ID</p>
			...
			<p>Phone Number</p>
			<input type="text" name="phone_number" size="60" value="<?php echo $infoStaff['phone_number']; ?>" required><br><br>

			<p>E-mail</p>
			<input type="text" name="staff_email" size="60" value="<?php echo $infoStaff['staff_email']; ?>" required><br><br>

			<p>Date Of Birth</p>
			<input type="text" name="date_of_birth" value="<?php echo $infoStaff['date_of_birth']; ?>" required><br><br>
			...
			<!--update button-->
			<button name="submit" type="submit" class="blueButton">UPDATE</button>

			<p><u><a href="password-change-staff.php">Change password?</a></u></p>
		</form>
	</div>
</div>
