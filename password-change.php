...
if (isset($_POST['hantar'])) {
	...
	if ($password == $infoStudent['password']) {
		// Update the password in the database
		$result = mysqli_query($con, "UPDATE student SET password='$newpassword' WHERE student_id='$STUDENTID'");
...
<div class="flex-container">
	...
	<div class="form-container-student">
		<form method="POST">
			...
			<input type="password" name="password" value="" autofocus required><br><br><br>
					
			<label>New Password</label><br><br>
			<input type="password" name="newpassword" size="45" value="" minlength="8" maxlength="20" required><br><br><br>    
