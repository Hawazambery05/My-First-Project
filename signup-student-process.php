...
if (!isset($student_id)) {
	...
	if (mysqli_num_rows($result) > 0) {
        ...
        VALUES ('" . $_POST['name'] . "', '" . $_POST['student_id'] . "', '" . $_POST['date_of_birth'] . "', '" . $_POST['gender'] . "', '" . $_POST['phone_number'] . "', '" . $_POST['student_email'] . "', '" . $_POST['faculty'] . "', '" . $_POST['password'] . "', '$verificationCode')";
		session_start();
