...
if (isset($_POST['submit'])) {
	$update = mysqli_query($con, "UPDATE issue SET return_status='1', fine='0' WHERE issue_id='$IDISSUE'");
		...
		<div class="form-container">
			...
			<div>
				<form method="POST">
					...
					<br><br>
					<!-- Confirmation Button -->
					<button name="submit" type="submit" class="greenButton lefttext changeButton">CONFIRM RETURN</button>
				</form>
			</div>
		</div>
	</div>
