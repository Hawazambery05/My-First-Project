...
<div class="flex-container">
	...
	<div class="form-container-student">
		<form method='POST'>
			...
			<!--update button-->
			<button name="submit" type="submit" class="purpleButton">UPDATE</button>

			<p><u><a href="password-change.php?student_id=<?php echo $infoStudent['student_id']; ?>">Change password?</a></u></p>
		</form>
	</div>
</div>
</body>
